...
#define motor0
	...
	uint16_t AS5048_mech_zeropos = 13561; // board0 13561 / board1 3779

	// motor electrical angle commutation
	uint16_t AS5048_zeropos = 14174;   // board0 14174 / board1 4060

	float pos_P = 1.0f;
	float pos_I = 0.0f;
	float pos_D = 0.4f;

	float W_M_LPF_ALPHA = 0.01f;
	...
	//mechanical zero position
	uint16_t AS5048_mech_zeropos = 3779; // board0 13561 / board1 3779

	// motor electrical angle commutation
	uint16_t AS5048_zeropos = 4060;   // board0 14174 / board1 4060

	float pos_P = 4.0f;
	float pos_I = 5.0f;
	float pos_D = 0.25f;

	float W_M_LPF_ALPHA = 0.02f;

	float POS_I_ENABLE_ERR = 0.2f;   // [rad]
	float POS_I_LIMIT_RATE = 0.8f;

#endif

#define IQ_REF_LIMIT    (0.8f)

float mech_limit = 2.5f;
